...
class AppDelegate: UIResponder, UIApplicationDelegate , UITabBarDelegate {
    ...
    var AppColor = UIColor(red: 235/255, green: 67/255, blue: 29/255, alpha: 1.0)
...
//*** Stripe App ID
//*** using publishableKey for local
        STPPaymentConfiguration.shared().publishableKey = "pk_test_CybQUXKMWAGdskpXhxKmWWp0"
...
//*** selected state
    ...
    lazy var persistentContainer: NSPersistentContainer = {
         ...
         */
        let container = NSPersistentContainer(name: "W3Shop")
