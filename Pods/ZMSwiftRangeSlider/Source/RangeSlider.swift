...
open class RangeSlider: UIControl {
    ...
    fileprivate var rangeValues = Array(0...7000)
   ...
   @IBInspectable open var maxValueThumbTintColor: UIColor = UIColor(white: 0.9, alpha: 1.0) {
    ...
    @IBInspectable open var trackHighlightTintColor: UIColor = UIColor(red: 235/255, green: 67/255, blue: 29/255, alpha: 1.0){
        //UIColor(red: 2.0 / 255, green: 192.0 / 255, blue: 92.0 / 255, alpha: 1.0) {
        didSet {
            updateLayerFrames()
        }
    }
    ...
    func updateLayerFrames() {
        ...
        maxValueDisplayLayer.frame = CGRect(x: maxValuePosition,
                                            y: displayLayerOffsetY,
                                            width: thumbSize + 10, //*** more width for 7000
                                            height: displayTextFontSize)
